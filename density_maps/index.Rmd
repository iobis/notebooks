---
title: "Record density maps for South Pacific and Artic"
...
make_subtitle <- function(type, projection) {
  return(paste0("Number of ", type, " per ISEA3H grid cell of approximately ", area_str, " square km (this corresponds to a ", square_side_deg_str, " by ", square_side_deg_str, " degree cell at the equator).\n", projection, ". Ocean Biogeographic Information System (OBIS), 2020."))
}
```
